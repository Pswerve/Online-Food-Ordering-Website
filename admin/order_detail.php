                ...
                <div class="card px-2">
                  <div class="card-body">
                    <div class="container-fluid">
                      <h3 class="my-5">Order No:&nbsp;<?php echo $id?></h3>
                      <hr>
                    </div>
                    <div class="container-fluid d-flex justify-content-between">
                      <div class="col-lg-3 pr-0">
                        <p class="mt-5 mb-2"><b>Delivery to,</b></p>
                        <p>
                    ...
                    <div class="container-fluid d-flex justify-content-between">
                      <div class="col-lg-3 pl-0">
                        <p class="mb-0 mt-5">Date: <?php  echo dateFormat($orderRow['added_on'])?></p>
                      </div>
                    </div>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr class="text-right">
                              ...
                              <td><?php echo $list['price']*$list['qty']?> Rs</td>
                            </tr>
							<?php
							$i++;
							} ?>
                    ...
                    <div class="container-fluid mt-5 w-100">
                      <h4 class="text-right mb-5">Final Amount: <?php echo $pp?> Rs</h4>
					  <?php
						if($orderRow['coupon_code']!=''){
						?>
						  <h4 class="text-right mb-5">Coupon Code: <?php echo $orderRow['coupon_code']?></h4>
						  <h4 class="text-right mb-5">Final Amount: <?php echo $orderRow['final_price']?> Rs</h4>
						<?php
						}
						?>
                      <hr>
