...
if(isset($_GET['set_order_id'])){
	...
	mysqli_query($con,"update order_master set payment_status='success',order_status=4,delivered_on='$delivered_on' where id='$set_order_id' and delivery_boy_id='".$_SESSION['DELIVERY_BOY_ID']."'");
}
         ...
         <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
               <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                  <a class="navbar-brand brand-logo" href="index.php"><img src="assets/images/delivery_boy_logo.jpg" alt="logo"/>
										<span class="text-primary">
											Delivery Boy Panel
										</span>
									</a>
                  <a class="navbar-brand brand-logo-mini" href="index.php"><img src="assets/images/delivery_boy_logo.jpg" alt="logo"/></a>
               </div>
            ...
            <div class="main-panel" style="width:100%;">
                                 ...
                                 <table id="order-listing" class="table">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                         ...
                                         <td style="font-size:14px;"><?php echo $row['final_price']?> Rs
               ...
               <!-- partial:partials/_footer.html -->
			           ...
			           <div class="d-sm-flex justify-content-center justify-content-sm-between">
			             <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Project by VIT Bhopal Students</span>
			           </div>
			         </footer>
			         <!-- partial -->
			       </div>
