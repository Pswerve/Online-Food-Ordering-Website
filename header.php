                    ...
                    <div class="row">
                            ...
                            <div class="welcome-area">
															...
															<div id="wallet_top_box">
																<a href="<?php echo FRONT_SITE_PATH?>wallet" style="color:#fff;">
																	Wallet: <?php echo $getWalletAmt?> Rs
																</a>
                        ...
                        <div class="col-lg-2 col-md-8 col-12 col-sm-8">
                            <div class="account-curr-lang-wrap f-right">
								...
								?>
								<ul>
                                    <li class="top-hover"><a href="#"><?php echo "Hello <span id='user_top_name'>".$_SESSION['FOOD_USER_NAME'];?></span>  <i class="ion-chevron-down"></i></a>
                                        <ul>
                                ...
                                <div class="header-login">
									...
									<a href="<?php echo FRONT_SITE_PATH?>login_register">
                                        ...
                                        <div class="login-text-content header_icon">
												...
												<p>Register<br> or <span>Login</span></p>
                                ...
                                <nav>
                                    <ul>
                                        ...
                                        <li><a href="<?php echo FRONT_SITE_PATH?>contact-us">contact us</a></li>
																				<li><a href="<?php echo ADMIN_SITE_PATH?>login.php">Admin Panel</a></li>
																				<li><a href="<?php echo DB_SITE_PATH?>login.php">Delivery Panel</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
