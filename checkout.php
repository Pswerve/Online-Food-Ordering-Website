...
if(isset($_POST['place_order'])){
	...
	if($is_error==''){
		...
		if($payment_type=='wallet'){
			manageWallet($_SESSION['FOOD_USER_ID'],$final_price,'out','Paid for Order No: '.$insert_id);
                            ...
                            <div id="faq" class="panel-group">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title"><span>1.</span> <a data-toggle="collapse" data-parent="#faq" href="#payment-1">CHECKOUT METHOD (ignore if logged in already)</a></h5>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title"><span>2.</span> <a data-toggle="collapse" data-parent="#faq" href="#payment-2">OTHER INFORMATION (available after login)</a></h5>
                                    </div>
                                        ...
                                        <div class="panel-body">
											<form method="post">
												<div class="billing-information-wrapper">
													...
													<div class="billing-back-btn">
														<div class="billing-btn">
															<button type="submit" name="place_order">Proceed</button>
														</div>
