...
function get_safe_value($str){  //whenever a string is passed, processed securely
	global $con;
...
function redirect($link) {
  ?>
  <script>
  window.location.href='<?php echo $link?>';  //use of js to redirect
  </script>
  <?php
  die(); //always use die while redirecting
}
...
function send_email($email,$html,$subject){
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="ofow.manager@gmail.com";
	$mail->Password="ofowadmin";
	$mail->setFrom("ofow.manager@gmail.com");
...
function orderEmail($oid,$uid=''){
  ...
  <body>
    <span class="preheader">Invoice for your order placed on '.FRONT_SITE_NAME.'</span>
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                ...
                <img src="https://i.ibb.co/F0G0mfd/logo.png"/>
              </a>
              </td>
            </tr>
            <!-- Email Body -->
            <tr>
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Hi '.$name.',</h1>
                        <p>This is an auto generated invoice for your recent order</p>
              ...
              <strong>Phone:</strong> '.$phone.'
                ...
                $total_price=0;
                  ...
                  $html.='<tr>
                    <td width="60%" class="purchase_item"><span class="f-fallback">'.$list['dish'].' ('.$list['attribute'].')</span></td>
                    <td width="20%" class="purchase_item"><span class="f-fallback">'.$list['qty'].'</span></td>
                    <td class="align-right" width="20%" class="purchase_item"><span class="f-fallback">'.$item_price.' Rs</span></td>
                  </tr>';
                                }
                                ...
                                $html.='<tr>
                                  ...
                                  <td width="20%" class="purchase_footer" valign="middle">
                                    <p class="f-fallback purchase_total">'.$total_price.' Rs</p>
                                  </td>
                                </tr>';
                ...
                if($getOrderById[0]['coupon_code']!=''){
                  $html.='<tr>
                                  ...
                                  <td width="80%" class="purchase_footer" valign="middle" colspan="2">
                                    <p class="f-fallback purchase_total purchase_total--label">Final Amount:</p>
                                  </td>
                                  <td width="20%" class="purchase_footer" valign="middle">
                                    <p class="f-fallback purchase_total">'.$getOrderById[0]['final_price'].' Rs</p>
                                  </td>
                                </tr>';
                        ...
                        <p>If you have any queries regarding this invoice, feel free to <a href="http://localhost/php/ofow/contact-us">contact us</a> for help.</p>
                        <p>Cheers,
